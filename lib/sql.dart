abstract class Sql {
  static List<String> sqls = <String>[
    ...
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',100.00,1,1,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',123.00,1,2,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',124.00,0,3,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',125.00,1,4,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',155.00,0,1,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',150.00,1,2,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',1043.00,0,3,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',121.00,1,4,1,1)",
    "INSERT INTO movimentacao (dataCriacao,dataVencimento,valor,tipo,id_conta,id_usuario,id_grupo) VALUES ('2020-01-01','2020-01-01',1120.00,0,2,1,1)",
  ];
}
